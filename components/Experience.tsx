          ...
          <Button
            ...
            <div className="flex lg:flex-row flex-col lg:item-center p-3 py-6 md:p-5 lg:p-10 gap-2">
              ...
              <div className="lg:ms-5">
                <h1 className="text-start text-xl md:text-2xl text-blue font-bold">
                  {card.title}
                </h1>
                <p className="text-start text-white-100">{card.date}</p>
                <p className="text-start mt-3 text-blue font-bold">
