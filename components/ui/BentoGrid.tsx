...
export const BentoGridItem = ({
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, #000319 0%, #0a0f2d 50%, #000319 100%)",
        // "linear-gradient(135deg, #000319 0%, #0d1b52 50%, #1e3a8a 100%)",
      }}>
            ...
            <div className="flex gap-1 md:gap-6 lg:gap-5 w-fit absolute right-2">
              <div className="flex flex-col gap-3 md:gap-6 lg:gap-8 md:mb-28 lg:mb-0">
                {leftLists.map((item) => (
                  <span
                    key={item}
                    className="cursor-default py-2 lg:py-4 lg:px-3 px-3 text-xs lg:text-base rounded-lg text-center bg-[#10132E] text-lightblue-100 opacity-60 transition-opacity duration-200 hover:opacity-100">
                    {item}
                  </span>
                ))}
