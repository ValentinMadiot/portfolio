...
export const fr = {
  ...
  projects: {
    ...
    sushi: {
      ...
      paragraphs: [
        "Projet client : j’ai accompagné le restaurant Sushikawa de la conception à la mise en ligne afin de valoriser leur identité culinaire et faciliter les réservations.",
    ...
    pizzeria: {
      ...
      paragraphs: [
        "Projet client : Pizza Bella souhaitait une présence en ligne moderne reflétant son savoir-faire artisanal et la qualité de ses ingrédients.",
    ...
    fruit: {
      ...
      paragraphs: [
        "Projet client : la boutique souhaitait un site clair, coloré et dynamique pour valoriser des fruits bio et locaux.",
    ...
    construction: {
      ...
      paragraphs: [
        "Projet client : l’entreprise de construction avait besoin d’une vitrine professionnelle mettant en avant ses services et réalisations.",
    ...
    bakery: {
      ...
      paragraphs: [
        "Projet client : la boulangerie voulait valoriser ses spécialités et attirer une clientèle de quartier et de passage.",
    ...
    salad: {
      ...
      paragraphs: [
        "Projet client : le restaurant de salades voulait un site léger, rapide et convaincant pour présenter son concept.",
